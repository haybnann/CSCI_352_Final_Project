...
\item The application will give the user their projecting retirement savings account worth based on a savings plan.
\end{itemize}

\subsubsection{Non-Functional}
\begin{itemize}
\item The data will be stored securely within the app/database.
